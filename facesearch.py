...
cascade = cv2.CascadeClassifier('D:\\project\\FaceSearch-master\\.facesearch\\face_alt.xml')
...
def Search():
    ...
    os.remove('icon.png')  # Removing the generated file
...
cascade = cv2.CascadeClassifier('C:\\Users\\Shriphad Rao\\AppData\\Local\\Programs\\Python\\Python37\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_alt2.xml')  # Load the CascadeClassifier
